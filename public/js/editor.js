...
document.querySelectorAll(".editor__previewbutton").forEach((x) => {
    x.addEventListener("click", () => {
        /* Apply the "hidden" class */
        let editor = document.querySelector(x.parentNode.dataset.editor);
        let options = document.querySelector(x.parentNode.dataset.options);
        let preview = document.querySelector(x.parentNode.dataset.preview);
...
document.querySelectorAll(".editor__editbutton").forEach((x) => {
    x.addEventListener("click", () => {
        /* Apply the "hidden" class */
        let editor = document.querySelector(x.parentNode.dataset.editor);
        let options = document.querySelector(x.parentNode.dataset.options);
